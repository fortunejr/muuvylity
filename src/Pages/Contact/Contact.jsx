    ...
    <div className="bg-gray-100 py-16 px-4">
      <div className="container mx-auto">
        ...
        <p className="text-center mb-10 text-lg text-gray-500 px-6 lg:px-60">
          Reach out to our team of seasoned professionals for real estate consultations,
          project discussions, or general inquiries.
        </p>
          ...
          <div className="lg:w-1/2 bg-white p-8 rounded-2xl shadow-md">
            ...
            <div className="space-y-4 text-gray-800 text-sm">
              ...
              <p className="flex items-center gap-3">
                ...
                <span><strong>Email:</strong> Omphoenixlimited@gmail.com</span>
              </p>
              <p className="flex items-center gap-3">
                <MdPhone className="text-customBlue text-xl" />
                <span><strong>Phone:</strong> +234 803 367 0069</span>
              </p>
            </div>
          </div>
